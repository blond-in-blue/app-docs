...
(function ($) {
  $.fn.scrollagent = function (options, callback) {
    ...
    var $sections = $(this);
    var $parent = options.parent || $(window); // Find the top offsets of each section
    ...
    var current = null;
    var height = null;
    var range = null; // Save the height. Do this only whenever the window is resized so we don't
    // recalculate often.
...
(function ($) {
  ...
  $.anchorjump = function (href, options) {
    ...
    $('body').trigger('anchor', href); // Add the location hash via pushState.
