...
(function ($) {
  ...
  Flatdoc.file = function (url) {
    function loadData(locations, response, callback) {
      if (locations.length === 0) callback(null, response);else $.get(locations.shift()).fail(function (e) {
        callback(e, null);
      }).done(function (data) {
  ...
  Parser.parse = function (source, highlight) {
    ...
    var title = h1.text(); // Mangle content
  ...
  Parser.setMarkedOptions = function (_highlight) {
    marked.setOptions({
...
(function (r) {
  ...
  downcode = function downcode(slug) {
